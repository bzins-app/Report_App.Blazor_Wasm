...
{
    public static string CreateTableFromSchema(DataTable dt, string? tableName, bool dropTable,
        List<string?>? primaryKeys = null)
    {
        ...
        foreach (DataColumn col in dt.Columns)
        {
            ...
            if (primaryKeys != null)
            {
                ...
                sqlCmd.Append((primaryKeys.Contains(col.ColumnName, StringComparer.OrdinalIgnoreCase) ? "NOT " : "") +
                              "NULL," +
                              Environment.NewLine);
            }
            else
